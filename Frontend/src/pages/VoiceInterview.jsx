...
export default function VoiceInterview() {
  ...
  const { setDetails, getQuestions, loading, error } = voiceInterviewStore();
              ...
              <div className="border border-border rounded-xl p-4 flex flex-col gap-4">
                ...
                <Button
                  ...
                  onClick={async () => {
                    ...
                    const { error, loading } = voiceInterviewStore.getState(); // read latest state
